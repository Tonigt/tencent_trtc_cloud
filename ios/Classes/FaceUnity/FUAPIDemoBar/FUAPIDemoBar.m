...
-(instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        //        self = [[NSBundle mainBundle] loadNibNamed:@"FUAPIDemoBar" owner:self options:nil].firstObject;
        //        self = (FUAPIDemoBar *)[bundle loadNibNamed:@"FUAPIDemoBar" owner:self options:nil].firstObject;
        NSURL *url = [bundle URLForResource:@"BeautyLib" withExtension:@"bundle"];
        NSBundle *b = [[NSBundle alloc] initWithURL:url];
        self = [b loadNibNamed:@"FUAPIDemoBar" owner:self options:nil].firstObject;
//        self.backgroundColor = [UIColor clearColor];
//        NSBundle *bundle = [NSBundle bundleForClass:[FUAPIDemoBar class]];
//        self = (FUAPIDemoBar *)[bundle loadNibNamed:@"FUAPIDemoBar" owner:self options:nil].firstObject;
        self.frame = frame;
...
@interface FuRenderKitBottomBar()
@property(nonatomic, strong) FUAPIDemoBar *_bottomView;
@end

@implementation FuRenderKitBottomBar

- (instancetype)initWithFrame:(CGRect)frame args:(id)args {
    self = [super init];
    if (self) {
        self._bottomView = [[FUAPIDemoBar alloc] initWithFrame:frame];
        self._bottomView.frame = frame;
        self._bottomView.mDelegate = self;
    }
    return self;
}
